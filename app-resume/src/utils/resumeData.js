...
export default{
    ...
    experinces:[
         ...
         {
            title:'Computer Science/Robotics/Turkish Teacher/ IT Specialist',
        ...
        },
        {
            ...
            date:'2007- 2009',
            description:'I thought C, C++, and C# classes for undergraduate students.'
        },
        {
            title:'Intern',
            date:'June-September 2006',
            description:'Barcode Reading (C#), Customer Following Program (C#): The three months program covered advanced topics in software engineering, SQL, Windows 2000 Server, and various Company Products.'
        },
        {
            title:'Teaching Asistant',
            date:'2005- 2007',
            description:'Helping professor with teaching programing basics to first year undergrad students.'
        }
